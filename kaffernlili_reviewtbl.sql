...
CREATE TABLE `reviewtbl` (
  `reviewIndex` int(11) NOT NULL AUTO_INCREMENT,
...
INSERT INTO `reviewtbl` VALUES (1,'오 드 뚜뢀렛 디스커버리 세트','testID','오 드 뚜뢀렛 디스커버리 세트 리뷰','testID@naver.com','참 좋은 제품','1234'),(2,'오 드 뚜왈렛','testID','오 드 뚜왈렛 세트 리뷰','rnduddn1226@gmail.com','참 좋은 제품입니다','1234');
